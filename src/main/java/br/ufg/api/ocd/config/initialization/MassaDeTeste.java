...
public class MassaDeTeste {
    ...
    private static String getNomeAnexo(String idAtendimento) {
        MultipartFile file = null;
        try {
            file = new MockMultipartFile("image", "", "image/jpeg", MassaDeTeste.class.getClassLoader().getResourceAsStream("file/Incisional.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        };
